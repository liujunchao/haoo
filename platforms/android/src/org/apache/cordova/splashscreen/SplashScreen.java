...
public class SplashScreen extends CordovaPlugin {
    ...
    private static final int DEFAULT_SPLASHSCREEN_DURATION = 12000;
    ...
    private void showSplashScreen(final boolean hideAfterDelay) {
        final int splashscreenTime =6000; //preferences.getInteger("SplashScreenDelay", DEFAULT_SPLASHSCREEN_DURATION);
